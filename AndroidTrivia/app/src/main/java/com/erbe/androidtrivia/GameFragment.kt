package com.erbe.androidtrivia
...
import com.erbe.androidtrivia.databinding.FragmentGameBinding
    ...
    override fun onCreateView(
        ...
        binding.submitButton.setOnClickListener { view: View ->
            ...
            if (-1 != checkedId) {
                var answersIndex = 0
                when (checkedId) {
                    R.id.secondAnswerRadioButton -> answersIndex = 1
                    R.id.thirdAnswerRadioButton -> answersIndex = 2
                    R.id.fourthAnswerRadioButton -> answersIndex = 3
                }
